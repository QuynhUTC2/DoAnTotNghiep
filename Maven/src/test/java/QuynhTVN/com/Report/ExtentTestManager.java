...
import QuynhTVN.com.Base.SetUp_Browser;
import QuynhTVN.com.TestCases.Init_Browser;
...
public class ExtentTestManager {
    ...
    public static WebDriver getDriver() {
        WebDriver driver = (WebDriver) Init_Browser.getDriver();
        return driver;
    }

    public static void addScreenShot(String message) {
        String base64Image = "data:image/png;base64,"
                + ((TakesScreenshot) Init_Browser.getDriver()).getScreenshotAs(OutputType.BASE64);
